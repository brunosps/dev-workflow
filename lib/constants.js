const COMMANDS = {
  en: [
    ...
    { name: 'dw-open-design', userInvoked: true, description: 'Trigger when user asks to generate or iterate headless Open Design HTML prototypes via the od CLI. Imports a target folder with isolated OD_DATA_DIR, runs web-prototype briefs with explicit --agent codex|claude, verifies files, captures JSONL audit logs, and stops for a dual >=9 visual gate.' },
  ...
  'pt-br': [
    ...
    { name: 'dw-open-design', userInvoked: true, description: 'Trigger quando usuario pede para gerar ou iterar prototipos HTML headless do Open Design via od CLI. Importa pasta alvo com OD_DATA_DIR isolado, roda briefs web-prototype com --agent codex|claude explicito, verifica arquivos, captura logs JSONL e para para gate visual dual >=9.' },
