const COMMANDS = {
  en: [
    ...
    { name: 'dw-claude-run', description: 'Run an approved task through Claude CLI in a dedicated worktree; return a durable session and evidence to the parent.' },
    ...
    { name: 'dw-copilot-run', description: 'Run an approved task through Copilot CLI in a dedicated worktree; return a durable session and evidence to the parent.' },
    ...
    { name: 'dw-open-design', description: 'Generate or iterate Open Design HTML prototypes through the od CLI, including screenshot-based redesign and visual verification.' },
  ...
  'pt-br': [
    ...
    { name: 'dw-claude-run', description: 'Executa task aprovada pela CLI Claude em worktree dedicado; retorna sessão durável e evidências ao parent.' },
    ...
    { name: 'dw-copilot-run', description: 'Executa task aprovada pela CLI Copilot em worktree dedicado; retorna sessão durável e evidências ao parent.' },
    ...
    { name: 'dw-open-design', description: 'Gera ou itera protótipos HTML Open Design pela CLI od, incluindo redesign por screenshots e verificação visual.' },
...
const PLATFORMS = {
  claude: {
    ...
    // auto-fires that command; the user invokes it explicitly with /<name>.
    // No bundled command sets this today (see docs/skills-ecosystem-comparison.md §2:
    // the lock is not a substitute for an authorization gate). It is kept for a
    // consumer's own commands, and test/wrappers.test.js exercises it directly so the
    // path cannot rot unnoticed while unused.
