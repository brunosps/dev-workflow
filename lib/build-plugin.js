...
const MARKETPLACE_DESCRIPTION =
  'À-la-carte dev-workflow skills for focused agent work: minimalism, search-first research, verification, security review, and code quality.';
...
module.exports = { buildManifests, run, MARKETPLACE_DESCRIPTION };
