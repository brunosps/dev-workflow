...
function listPostUpdateActions(projectRoot) {
  ...
  actions.push({
    ...
    reason: 'audit refreshed skills and compare .dw/config/routing.json with managed routing-defaults.json; preserve owner choices and approved plans',
  });
...
function printPostUpdateActions(projectRoot) {
  ...
  console.log('    Read the refreshed .dw/commands/dw-update.md before following the post-update instructions.');
