...
const { inspectInstructions } = require('./instruction-health');
...
function run() {
  ...
  issues.push(...inspectInstructions().issues);
  ...
  console.log('PASS: skill + agent registries valid; instruction budgets valid; plugin manifests in sync.');
}
