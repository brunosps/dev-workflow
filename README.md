...
dev-workflow v1.1.1 ships **31 commands** organized into four tiers. Most users only invoke Tier 1 + Tier 2.
...
npx @brunosps00/dev-workflow setup-wsl-browser             # WSL NAT: build CDP relay + add Hyper-V firewall rule
