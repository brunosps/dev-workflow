...
| `wsl`, `browser`, `playwright browser`, `cdp` | `npx @brunosps00/dev-workflow setup-wsl-browser` instala o relay reverso no contexto do usuário quando WSL NAT precisa dirigir o browser real do Windows |
